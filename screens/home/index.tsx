    ...
    return (
        <>
            ...
            <section className={`about ${about}`}>
                <div
                    className={`about__heading ${aboutHeading} cursive heading`}
                >
                    Hi There
                </div>
                ...
                <div className={`about__text  ${aboutText}`}>
                    <p className={'about__text--section'}>
                        I am Richa - the human behind this lens. Welcome to my
                        kitchen. I hope you found something interesting to cook
                        today.
                    </p>
                    <p className={'about__text--section'}>
                        If you are still confused, then try my all time
                        favourite kadhi chawal. Then we can know more about each
                        other. Everything feels good after a happy meal :)
                    </p>
                </div>
            </section>
            ...
            <section className={`cookbook ${cookbook}`}>
                ...
                <div className={`cookbook__text text_center ${cookbookText}`}>
                    <p>
                        This is my first recipe book which is a collection of 30
                        delicious and addictive vegetarian/vegan salads. And it
                        is my guarantee that these recipes will make you fall in
                        love with salads.
                    </p>
                </div>
