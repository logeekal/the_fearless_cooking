    ...
    >
      <div className={`${stylePrefix}__container ${styles.container}`}>
        ...
        <div className={`${stylePrefix}__content} ${styles.content}`}>
          ...
          <div
            className={`content__footer ${styles.contentFooter} text_center `}
          >
            <form
            ...
            >
              {formSubmitStatus !== 'idle' ? (
                <Loader
                  status={
                    formSubmitStatus === 'pending' ? 'loading' : 'success'
                  }
                />
              ) : null}
              {formSubmitStatus === 'idle' ? (
              ...
              {formSubmitStatus === 'success' || formSubmitStatus == 'error'
                ? 'Yayyy 🥳. You secured a free copy of "Fall in love with Salads"'
                : null}
              {formSubmitStatus === 'idle' ? (
                <button
