  ...
  return (
    <section className={`support ${support}`}>
      ...
      <div className="support__text text_center">
        <p>
          I know how annoying it is to see the unwanted ads popping all over the
          place and distracting while you are reading something. That’s why, I
          will always keep this place clean and distraction free for you.
          Afterall, it’s always nice to be served on a clean plate :D
        </p>
        <p>
