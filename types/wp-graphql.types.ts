...
/** Input for the createRecipeIngredient mutation */
export type CreateRecipeIngredientInput = {
    /** The slug that the recipe_ingredients will be an alias of */
    aliasOf?: InputMaybe<Scalars['String']>
    /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
    clientMutationId?: InputMaybe<Scalars['String']>
    /** The description of the recipe_ingredients object */
    description?: InputMaybe<Scalars['String']>
    /** The name of the recipe_ingredients object to mutate */
    name: Scalars['String']
    /** The ID of the recipe_ingredients that should be set as the parent */
    parentId?: InputMaybe<Scalars['ID']>
    /** If this argument exists then the slug will be checked to see if it is not an existing valid term. If that check succeeds (it is not a valid term), then it is added and the term id is given. If it fails, then a check is made to whether the taxonomy is hierarchical and the parent argument is not empty. If the second check succeeds, the term will be inserted and the term id will be given. If the slug argument is empty, then it will be calculated from the term name. */
    slug?: InputMaybe<Scalars['String']>
}

/** The payload for the createRecipeIngredient mutation */
export type CreateRecipeIngredientPayload = {
    __typename?: 'CreateRecipeIngredientPayload'
    /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
    clientMutationId?: Maybe<Scalars['String']>
    /** The created recipe_ingredients */
...
export type CreateRecipeInput = {
    ...
    recipeCourses?: InputMaybe<RecipeRecipeCoursesInput>
    /** Set connections between the recipe and recipeCuisines */
    recipeCuisines?: InputMaybe<RecipeRecipeCuisinesInput>
    /** Set connections between the recipe and RecipeIngredients */
    recipeIngredients?: InputMaybe<RecipeRecipeIngredientsInput>
    /** The slug of the object */
    slug?: InputMaybe<Scalars['String']>
    /** The status of the object */
    status?: InputMaybe<PostStatusEnum>
...
/** Input for the deleteRecipeIngredient mutation */
export type DeleteRecipeIngredientInput = {
    /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
    clientMutationId?: InputMaybe<Scalars['String']>
    /** The ID of the RecipeIngredient to delete */
    id: Scalars['ID']
}

/** The payload for the deleteRecipeIngredient mutation */
...
export type FaqCommentsArgs = {
    ...
    first?: InputMaybe<Scalars['Int']>
    last?: InputMaybe<Scalars['Int']>
    where?: InputMaybe<FaqToCommentConnectionWhereArgs>
}
...
export type PostObjectUnion = Faq | MediaItem | Page | Post | Recipe
...
/** The recipe type */
export type Recipe = ContentNode &
    DatabaseIdentifier &
    MenuItemLinkable &
    Node &
    NodeWithAuthor &
    ...
    UniformResourceIdentifiable & {
        ...
        /** Connection between the recipe type and the RecipeIngredient type */
        recipeIngredients?: Maybe<RecipeToRecipeIngredientConnection>
        /** The uri slug for the post. This is equivalent to the WP_Post-&gt;post_name field and the post_name column in the database for the &quot;post_objects&quot; table. */
        slug?: Maybe<Scalars['String']>
        /** The current status of the object */
        status?: Maybe<Scalars['String']>
...
export type RecipeCommentsArgs = {
    ...
    first?: InputMaybe<Scalars['Int']>
    last?: InputMaybe<Scalars['Int']>
    where?: InputMaybe<RecipeToCommentConnectionWhereArgs>
}
...
export type RecipeRecipeCoursesArgs = {
    ...
    first?: InputMaybe<Scalars['Int']>
    last?: InputMaybe<Scalars['Int']>
    where?: InputMaybe<RecipeToRecipeCourseConnectionWhereArgs>
}
...
export type RecipeRecipeCuisinesArgs = {
    ...
    first?: InputMaybe<Scalars['Int']>
    last?: InputMaybe<Scalars['Int']>
    where?: InputMaybe<RecipeToRecipeCuisineConnectionWhereArgs>
}
...
export type RecipeRecipeIngredientsArgs = {
    ...
    first?: InputMaybe<Scalars['Int']>
    last?: InputMaybe<Scalars['Int']>
    where?: InputMaybe<RecipeToRecipeIngredientConnectionWhereArgs>
}
...
export type RecipeTermsArgs = {
    ...
    first?: InputMaybe<Scalars['Int']>
    last?: InputMaybe<Scalars['Int']>
    where?: InputMaybe<RecipeToTermNodeConnectionWhereArgs>
}
...
export type RecipeCourse = DatabaseIdentifier &
    HierarchicalTermNode &
    MenuItemLinkable &
    Node &
    TermNode &
...
export type RecipeCourseChildrenArgs = {
    ...
    first?: InputMaybe<Scalars['Int']>
    last?: InputMaybe<Scalars['Int']>
    where?: InputMaybe<RecipeCourseToRecipeCourseConnectionWhereArgs>
}
...
export type RecipeCourseContentNodesArgs = {
    ...
    first?: InputMaybe<Scalars['Int']>
    last?: InputMaybe<Scalars['Int']>
    where?: InputMaybe<RecipeCourseToContentNodeConnectionWhereArgs>
}
...
export type RecipeCourseRecipesArgs = {
    ...
    first?: InputMaybe<Scalars['Int']>
    last?: InputMaybe<Scalars['Int']>
    where?: InputMaybe<RecipeCourseToRecipeConnectionWhereArgs>
}
...
export type RecipeCourseToAncestorsRecipeCourseConnection = {
    ...
    edges?: Maybe<
        Array<Maybe<RecipeCourseToAncestorsRecipeCourseConnectionEdge>>
    >
    /** The nodes of the connection, without the edges */
...
export type RecipeCuisine = DatabaseIdentifier &
    HierarchicalTermNode &
    MenuItemLinkable &
    Node &
    TermNode &
...
export type RecipeCuisineChildrenArgs = {
    ...
    first?: InputMaybe<Scalars['Int']>
    last?: InputMaybe<Scalars['Int']>
    where?: InputMaybe<RecipeCuisineToRecipeCuisineConnectionWhereArgs>
}
...
export type RecipeCuisineContentNodesArgs = {
    ...
    first?: InputMaybe<Scalars['Int']>
    last?: InputMaybe<Scalars['Int']>
    where?: InputMaybe<RecipeCuisineToContentNodeConnectionWhereArgs>
}
...
export type RecipeCuisineRecipesArgs = {
    ...
    first?: InputMaybe<Scalars['Int']>
    last?: InputMaybe<Scalars['Int']>
    where?: InputMaybe<RecipeCuisineToRecipeConnectionWhereArgs>
}
...
export type RecipeCuisineToAncestorsRecipeCuisineConnection = {
    ...
    edges?: Maybe<
        Array<Maybe<RecipeCuisineToAncestorsRecipeCuisineConnectionEdge>>
    >
    /** The nodes of the connection, without the edges */
...
/** The RecipeIngredient type */
export type RecipeIngredient = DatabaseIdentifier &
    HierarchicalTermNode &
    MenuItemLinkable &
    Node &
    TermNode &
    UniformResourceIdentifiable & {
        ...
        /** The ancestors of the node. Default ordered as lowest (closest to the child) to highest (closest to the root). */
        ancestors?: Maybe<RecipeIngredientToAncestorsRecipeIngredientConnection>
        /** Connection between the RecipeIngredient type and the RecipeIngredient type */
        children?: Maybe<RecipeIngredientToRecipeIngredientConnection>
        /** Connection between the RecipeIngredient type and the ContentNode type */
        contentNodes?: Maybe<RecipeIngredientToContentNodeConnection>
        /** The number of objects connected to the object */
        count?: Maybe<Scalars['Int']>
        /** Identifies the primary key from the database. */
        databaseId: Scalars['Int']
        ...
        name?: Maybe<Scalars['String']>
        /** Connection between the RecipeIngredient type and the RecipeIngredient type */
        parent?: Maybe<RecipeIngredientToParentRecipeIngredientConnectionEdge>
        /** Database id of the parent node */
        parentDatabaseId?: Maybe<Scalars['Int']>
        /** The globally unique identifier of the parent node. */
        parentId?: Maybe<Scalars['ID']>
         ...
         * @deprecated Deprecated in favor of databaseId
         */
        recipeIngredientId?: Maybe<Scalars['Int']>
        /** Connection between the RecipeIngredient type and the recipe type */
        recipes?: Maybe<RecipeIngredientToRecipeConnection>
        /** An alphanumeric identifier for the object unique to its type. */
        slug?: Maybe<Scalars['String']>
        /** Connection between the RecipeIngredient type and the Taxonomy type */
        taxonomy?: Maybe<RecipeIngredientToTaxonomyConnectionEdge>
        /** The ID of the term group that this term object belongs to */
        termGroupId?: Maybe<Scalars['Int']>
        /** The taxonomy ID that the object is associated with */
        termTaxonomyId?: Maybe<Scalars['Int']>
...
/** The RecipeIngredient type */
export type RecipeIngredientAncestorsArgs = {
    after?: InputMaybe<Scalars['String']>
    before?: InputMaybe<Scalars['String']>
    first?: InputMaybe<Scalars['Int']>
    last?: InputMaybe<Scalars['Int']>
...
/** The RecipeIngredient type */
export type RecipeIngredientChildrenArgs = {
    after?: InputMaybe<Scalars['String']>
    before?: InputMaybe<Scalars['String']>
    first?: InputMaybe<Scalars['Int']>
    last?: InputMaybe<Scalars['Int']>
    where?: InputMaybe<RecipeIngredientToRecipeIngredientConnectionWhereArgs>
}

/** The RecipeIngredient type */
export type RecipeIngredientContentNodesArgs = {
    after?: InputMaybe<Scalars['String']>
    before?: InputMaybe<Scalars['String']>
    first?: InputMaybe<Scalars['Int']>
    last?: InputMaybe<Scalars['Int']>
    where?: InputMaybe<RecipeIngredientToContentNodeConnectionWhereArgs>
}

/** The RecipeIngredient type */
export type RecipeIngredientEnqueuedScriptsArgs = {
    after?: InputMaybe<Scalars['String']>
    before?: InputMaybe<Scalars['String']>
    first?: InputMaybe<Scalars['Int']>
    last?: InputMaybe<Scalars['Int']>
...
/** The RecipeIngredient type */
export type RecipeIngredientEnqueuedStylesheetsArgs = {
    after?: InputMaybe<Scalars['String']>
    before?: InputMaybe<Scalars['String']>
    first?: InputMaybe<Scalars['Int']>
    last?: InputMaybe<Scalars['Int']>
...
/** The RecipeIngredient type */
export type RecipeIngredientRecipesArgs = {
    after?: InputMaybe<Scalars['String']>
    before?: InputMaybe<Scalars['String']>
    first?: InputMaybe<Scalars['Int']>
    last?: InputMaybe<Scalars['Int']>
    where?: InputMaybe<RecipeIngredientToRecipeConnectionWhereArgs>
}

/** The Type of Identifier used to fetch a single resource. Default is ID. */
export enum RecipeIngredientIdType {
    /** The Database ID for the node */
    DatabaseId = 'DATABASE_ID',
    /** The hashed Global ID */
    Id = 'ID',
...
/** Connection between the RecipeIngredient type and the RecipeIngredient type */
export type RecipeIngredientToAncestorsRecipeIngredientConnection = {
    __typename?: 'RecipeIngredientToAncestorsRecipeIngredientConnection'
    /** Edges for the RecipeIngredientToAncestorsRecipeIngredientConnection connection */
    edges?: Maybe<
        Array<Maybe<RecipeIngredientToAncestorsRecipeIngredientConnectionEdge>>
    >
    /** The nodes of the connection, without the edges */
    nodes?: Maybe<Array<Maybe<RecipeIngredient>>>
    /** Information about pagination in a connection. */
    pageInfo?: Maybe<WpPageInfo>
}

/** An edge in a connection */
export type RecipeIngredientToAncestorsRecipeIngredientConnectionEdge = {
    __typename?: 'RecipeIngredientToAncestorsRecipeIngredientConnectionEdge'
    /** A cursor for use in pagination */
    cursor?: Maybe<Scalars['String']>
    /** The item at the end of the edge */
...
/** Connection between the RecipeIngredient type and the ContentNode type */
export type RecipeIngredientToContentNodeConnection = {
    __typename?: 'RecipeIngredientToContentNodeConnection'
    /** Edges for the RecipeIngredientToContentNodeConnection connection */
    edges?: Maybe<Array<Maybe<RecipeIngredientToContentNodeConnectionEdge>>>
    /** The nodes of the connection, without the edges */
    nodes?: Maybe<Array<Maybe<ContentNode>>>
    /** Information about pagination in a connection. */
    pageInfo?: Maybe<WpPageInfo>
...
/** An edge in a connection */
export type RecipeIngredientToContentNodeConnectionEdge = {
    __typename?: 'RecipeIngredientToContentNodeConnectionEdge'
    /** A cursor for use in pagination */
    cursor?: Maybe<Scalars['String']>
    /** The item at the end of the edge */
    node?: Maybe<ContentNode>
...
/** Arguments for filtering the RecipeIngredientToContentNodeConnection connection */
export type RecipeIngredientToContentNodeConnectionWhereArgs = {
    /** Filter the connection based on dates */
    dateQuery?: InputMaybe<DateQueryInput>
    /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
    hasPassword?: InputMaybe<Scalars['Boolean']>
...
/** Connection between the RecipeIngredient type and the RecipeIngredient type */
export type RecipeIngredientToParentRecipeIngredientConnectionEdge = {
    __typename?: 'RecipeIngredientToParentRecipeIngredientConnectionEdge'
    /** The nodes of the connection, without the edges */
    node?: Maybe<RecipeIngredient>
}

/** Connection between the RecipeIngredient type and the recipe type */
export type RecipeIngredientToRecipeConnection = {
    __typename?: 'RecipeIngredientToRecipeConnection'
    /** Edges for the RecipeIngredientToRecipeConnection connection */
    edges?: Maybe<Array<Maybe<RecipeIngredientToRecipeConnectionEdge>>>
    /** The nodes of the connection, without the edges */
    nodes?: Maybe<Array<Maybe<Recipe>>>
    /** Information about pagination in a connection. */
    pageInfo?: Maybe<WpPageInfo>
...
/** An edge in a connection */
export type RecipeIngredientToRecipeConnectionEdge = {
    __typename?: 'RecipeIngredientToRecipeConnectionEdge'
    /** A cursor for use in pagination */
    cursor?: Maybe<Scalars['String']>
    /** The item at the end of the edge */
    node?: Maybe<Recipe>
...
/** Arguments for filtering the RecipeIngredientToRecipeConnection connection */
export type RecipeIngredientToRecipeConnectionWhereArgs = {
    /** The user that's connected as the author of the object. Use the userId for the author object. */
    author?: InputMaybe<Scalars['Int']>
    /** Find objects connected to author(s) in the array of author's userIds */
    authorIn?: InputMaybe<Array<InputMaybe<Scalars['ID']>>>
...
/** Connection between the RecipeIngredient type and the RecipeIngredient type */
export type RecipeIngredientToRecipeIngredientConnection = {
    __typename?: 'RecipeIngredientToRecipeIngredientConnection'
    /** Edges for the RecipeIngredientToRecipeIngredientConnection connection */
    edges?: Maybe<
        Array<Maybe<RecipeIngredientToRecipeIngredientConnectionEdge>>
    >
    /** The nodes of the connection, without the edges */
    nodes?: Maybe<Array<Maybe<RecipeIngredient>>>
    /** Information about pagination in a connection. */
...
/** An edge in a connection */
export type RecipeIngredientToRecipeIngredientConnectionEdge = {
    __typename?: 'RecipeIngredientToRecipeIngredientConnectionEdge'
    /** A cursor for use in pagination */
    cursor?: Maybe<Scalars['String']>
    /** The item at the end of the edge */
    node?: Maybe<RecipeIngredient>
...
/** Arguments for filtering the RecipeIngredientToRecipeIngredientConnection connection */
export type RecipeIngredientToRecipeIngredientConnectionWhereArgs = {
    /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
    cacheDomain?: InputMaybe<Scalars['String']>
    /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
    childOf?: InputMaybe<Scalars['Int']>
...
/** Connection between the RecipeIngredient type and the Taxonomy type */
export type RecipeIngredientToTaxonomyConnectionEdge = {
    __typename?: 'RecipeIngredientToTaxonomyConnectionEdge'
    /** The nodes of the connection, without the edges */
    node?: Maybe<Taxonomy>
}
...
export type RecipeRecipeCoursesInput = {
    ...
    append?: InputMaybe<Scalars['Boolean']>
    /** The input list of items to set. */
    nodes?: InputMaybe<Array<InputMaybe<RecipeRecipeCoursesNodeInput>>>
}
...
export type RecipeRecipeCuisinesInput = {
    ...
    append?: InputMaybe<Scalars['Boolean']>
    /** The input list of items to set. */
    nodes?: InputMaybe<Array<InputMaybe<RecipeRecipeCuisinesNodeInput>>>
}
...
/** Set relationships between the recipe to RecipeIngredients */
export type RecipeRecipeIngredientsInput = {
    /** If true, this will append the RecipeIngredient to existing related RecipeIngredients. If false, this will replace existing relationships. Default true. */
    append?: InputMaybe<Scalars['Boolean']>
    /** The input list of items to set. */
    nodes?: InputMaybe<Array<InputMaybe<RecipeRecipeIngredientsNodeInput>>>
}

/** List of RecipeIngredients to connect the recipe to. If an ID is set, it will be used to create the connection. If not, it will look for a slug. If neither are valid existing terms, and the site is configured to allow terms to be created during post mutations, a term will be created using the Name if it exists in the input, then fallback to the slug if it exists. */
export type RecipeRecipeIngredientsNodeInput = {
    /** The description of the RecipeIngredient. This field is used to set a description of the RecipeIngredient if a new one is created during the mutation. */
    description?: InputMaybe<Scalars['String']>
    /** The ID of the RecipeIngredient. If present, this will be used to connect to the recipe. If no existing RecipeIngredient exists with this ID, no connection will be made. */
    id?: InputMaybe<Scalars['ID']>
    /** The name of the RecipeIngredient. This field is used to create a new term, if term creation is enabled in nested mutations, and if one does not already exist with the provided slug or ID or if a slug or ID is not provided. If no name is included and a term is created, the creation will fallback to the slug field. */
    name?: InputMaybe<Scalars['String']>
    /** The slug of the RecipeIngredient. If no ID is present, this field will be used to make a connection. If no existing term exists with this slug, this field will be used as a fallback to the Name field when creating a new term to connect to, if term creation is enabled as a nested mutation. */
    slug?: InputMaybe<Scalars['String']>
}
...
/** Connection between the recipe type and the RecipeIngredient type */
export type RecipeToRecipeIngredientConnection = {
    __typename?: 'RecipeToRecipeIngredientConnection'
    /** Edges for the RecipeToRecipeIngredientConnection connection */
    edges?: Maybe<Array<Maybe<RecipeToRecipeIngredientConnectionEdge>>>
    /** The nodes of the connection, without the edges */
    nodes?: Maybe<Array<Maybe<RecipeIngredient>>>
    /** Information about pagination in a connection. */
    pageInfo?: Maybe<WpPageInfo>
...
/** An edge in a connection */
export type RecipeToRecipeIngredientConnectionEdge = {
    __typename?: 'RecipeToRecipeIngredientConnectionEdge'
    /** A cursor for use in pagination */
    cursor?: Maybe<Scalars['String']>
    /** The item at the end of the edge */
    node?: Maybe<RecipeIngredient>
...
/** Arguments for filtering the RecipeToRecipeIngredientConnection connection */
export type RecipeToRecipeIngredientConnectionWhereArgs = {
    /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
    cacheDomain?: InputMaybe<Scalars['String']>
    /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
    childOf?: InputMaybe<Scalars['Int']>
...
export type RootMutation = {
    ...
    /** The payload for the UpdateRecipeIngredient mutation */
...
/** The root mutation */
export type RootMutationCreateRecipeIngredientArgs = {
...
/** The root mutation */
export type RootMutationDeleteRecipeIngredientArgs = {
...
/** The root mutation */
export type RootMutationUpdateRecipeIngredientArgs = {
...
export type RootQuery = {
    ...
    /** A 0bject */
    recipeIngredient?: Maybe<RecipeIngredient>
    /** Connection between the RootQuery type and the RecipeIngredient type */
    recipeIngredients?: Maybe<RootQueryToRecipeIngredientConnection>
...
export type RootQueryRecipeCourseArgs = {
    id: Scalars['ID']
    idType?: InputMaybe<RecipeCourseIdType>
}
...
export type RootQueryRecipeCoursesArgs = {
    ...
    first?: InputMaybe<Scalars['Int']>
    last?: InputMaybe<Scalars['Int']>
    where?: InputMaybe<RootQueryToRecipeCourseConnectionWhereArgs>
}

/** The root entry point into the Graph */
export type RootQueryRecipeCuisineArgs = {
    id: Scalars['ID']
    idType?: InputMaybe<RecipeCuisineIdType>
}
...
export type RootQueryRecipeCuisinesArgs = {
    ...
    first?: InputMaybe<Scalars['Int']>
    last?: InputMaybe<Scalars['Int']>
    where?: InputMaybe<RootQueryToRecipeCuisineConnectionWhereArgs>
}

/** The root entry point into the Graph */
export type RootQueryRecipeIngredientArgs = {
    id: Scalars['ID']
    idType?: InputMaybe<RecipeIngredientIdType>
}

/** The root entry point into the Graph */
export type RootQueryRecipeIngredientsArgs = {
    after?: InputMaybe<Scalars['String']>
    before?: InputMaybe<Scalars['String']>
    first?: InputMaybe<Scalars['Int']>
    last?: InputMaybe<Scalars['Int']>
    where?: InputMaybe<RootQueryToRecipeIngredientConnectionWhereArgs>
}
...
/** Connection between the RootQuery type and the RecipeIngredient type */
export type RootQueryToRecipeIngredientConnection = {
    __typename?: 'RootQueryToRecipeIngredientConnection'
    /** Edges for the RootQueryToRecipeIngredientConnection connection */
    edges?: Maybe<Array<Maybe<RootQueryToRecipeIngredientConnectionEdge>>>
    /** The nodes of the connection, without the edges */
    nodes?: Maybe<Array<Maybe<RecipeIngredient>>>
    /** Information about pagination in a connection. */
    pageInfo?: Maybe<WpPageInfo>
...
/** An edge in a connection */
export type RootQueryToRecipeIngredientConnectionEdge = {
    __typename?: 'RootQueryToRecipeIngredientConnectionEdge'
    /** A cursor for use in pagination */
    cursor?: Maybe<Scalars['String']>
    /** The item at the end of the edge */
    node?: Maybe<RecipeIngredient>
...
/** Arguments for filtering the RootQueryToRecipeIngredientConnection connection */
export type RootQueryToRecipeIngredientConnectionWhereArgs = {
    /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
    cacheDomain?: InputMaybe<Scalars['String']>
    /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
    childOf?: InputMaybe<Scalars['Int']>
...
export enum TaxonomyEnum {
    ...
    /** Taxonomy enum recipe_ingredients */
...
/** Input for the UpdateRecipeIngredient mutation */
export type UpdateRecipeIngredientInput = {
    ...
    /** The description of the recipe_ingredients object */
    description?: InputMaybe<Scalars['String']>
    /** The ID of the RecipeIngredient object to update */
    id: Scalars['ID']
    /** The name of the recipe_ingredients object to mutate */
    name?: InputMaybe<Scalars['String']>
    /** The ID of the recipe_ingredients that should be set as the parent */
...
export type UserFaqsArgs = {
    ...
    first?: InputMaybe<Scalars['Int']>
    last?: InputMaybe<Scalars['Int']>
    where?: InputMaybe<UserToFaqConnectionWhereArgs>
}
